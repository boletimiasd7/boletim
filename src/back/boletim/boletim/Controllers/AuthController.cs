...
namespace boletim.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IGoogleAuthClient googleAuthClient, IJwtService jwtService)
        {
        ...
        public async Task<IActionResult> GoogleLogin(GoogleLoginRequest request)
        {
            ...
            var userEmail = await JwtDecoder.GetEmailAsync(googleTokens.IdToken, _clientId);
